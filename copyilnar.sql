...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 22 2023 г., 14:40
...
INSERT INTO `products` (`id`, `product`, `categoryId`, `price`, `image`, `year`, `country_id`) VALUES
(11, 'МФУ лазерное Pantum M65025 Москва, год выпуска 2005', 2, 12499, 'https://c.dns-shop.ru/thumb/st4/fit/500/500/5bf25c4a9e846918f6e015e0a9671c11/c16a26e9ac15d5530395b0992f62c0f368d063c513e5bc5c37c3dc08b683d6b4.jpg.webp', 2023, 1),
...
(2, 'admin', 'admin11', 'Вострикова', 'Полина', 'Максимовна', 'admin@mail.ru', 2),
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `countries` (`country_id`) ON DELETE CASCADE ON UPDATE CASCADE;
